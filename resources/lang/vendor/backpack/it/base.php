...
return [
    ...
    */
    ...
    'step'                   => 'Passo',
    'confirm_email'          => "", //"Inserisci la tua mail",
    'choose_new_password'    => "", //"Scegli una nuova password",
    'confirm_new_password'   => "Conferma Password",
    'password_reset'    => [
        'greeting'           => "Ripristino password",
        'line_1'             => "Per ripristinare la tua password clicka sul link sottostante.",
        'line_2'             => "Ti verrà richiesto di definire una nuova password.",
